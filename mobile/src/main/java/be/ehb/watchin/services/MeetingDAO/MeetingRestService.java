 ...
 */
public class MeetingRestService extends IntentService{
    ...
    private static final String TAG = "MeetingRestService";
    private static final int MY_SOCKET_TIMEOUT_MS = 5000;

    private static String server = WatchInApp.server;
    private static String path = WatchInApp.path.meeting;

    public static final String JSON_MID = "mid";
    public static final String BUN_MID = "BUN_MID";
    ...
    private Response.ErrorListener errorListener = new Response.ErrorListener() {
        ...
        public void onErrorResponse(VolleyError error) {
            ...
            resultReceiver.send(MeetingResultReceiver.ERROR_RECEIVING,null);
        }
    };


    public MeetingRestService() {
        super("MeetingRestService");
    }
    ...
    public static void startActionGetByID(Context context, int ID, MeetingResultReceiver receiver) {
        Intent intent = new Intent(context, MeetingRestService.class);
    ...
    public static void startActionGetAll(Context context,MeetingResultReceiver receiver) {
        Intent intent = new Intent(context, MeetingRestService.class);
        ...
        public void onResponse(JSONObject jsonObject) {
            ...
            */
            ...
            try {
                ...
                bundle.putInt(BUN_MID,jsonObject.getInt(JSON_MID));
            } catch (JSONException e) {
                e.printStackTrace();
            }
            //Log.d(TAG,bundle.toString());
            resultReceiver.send(MeetingResultReceiver.RESULT_ONE,bundle);
        }
    };
